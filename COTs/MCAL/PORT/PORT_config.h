...
#define PORTC_PIN0_VALUE			HIGH
#define PORTC_PIN1_VALUE			HIGH
#define PORTC_PIN2_VALUE			HIGH
#define PORTC_PIN3_VALUE			PULLUP
#define PORTC_PIN4_VALUE			PULLUP
#define PORTC_PIN5_VALUE			PULLUP
#define PORTC_PIN6_VALUE			PULLUP
